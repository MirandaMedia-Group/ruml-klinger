			...
			<div class="container">
				...
				<div class="footer-block">
					...
					<nav>
						<ul>
							<li>
								<a href="https://www.ruml-group.cz" target="_blank"> RUML GROUP </a>
							</li>
							<li>
								<a href="https://www.ruml-service.cz" target="_blank"> RUML Service s.r.o. </a>
							</li>
							<li>
								<a href="https://www.ruml-industry.cz" target="_blank"> RUML Industry s.r.o. </a>
							</li>
							<li>
								<a href="https://www.ruml-emes.sk" target="_blank"> RUML Emes s.r.o. </a>
							</li>
							<li>
		...
		ul {
			...
			li {
				a {
					...
					padding: em(10) em(10) em(10) em(15);
					font-weight: 300;
					&::before {
						position: absolute;
						left: 0;
